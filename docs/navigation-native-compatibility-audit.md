...
- Keep `react-native-gesture-handler@2.29.1`, `react-native-screens@4.24.0`, and `react-native-safe-area-context@5.8.0` fixed until the next RN milestone branch.
