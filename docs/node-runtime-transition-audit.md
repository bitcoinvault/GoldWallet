...
- Current React Native: `0.86.2`
- Current RN Babel preset: `0.86.2`
- Current RN Metro config: `0.86.2`

## Target Snapshot

- Target React Native snapshot: `0.86.2`
- Target RN Node engine snapshot: `^20.19.4 || ^22.13.0 || ^24.3.0 || >= 25.0.0`

## Coupling Rules

- Keep `.nvmrc` on `24.16.0` for the RN 0.86.2 foundation checkpoint and Node 24 tooling baseline.
