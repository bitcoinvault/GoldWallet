...
- Current React Native: `0.87.0`
- Current RN Babel preset: `0.87.0`
- Current RN Metro config: `0.87.0`

## Target Snapshot

- Target React Native snapshot: `0.87.0`
- Target RN Node engine snapshot: `^22.13.0 || ^24.3.0 || >= 26.0.0`

## Coupling Rules

- Keep `.nvmrc` on `24.16.0` for the RN 0.87.0 foundation checkpoint and Node 24 tooling baseline.
