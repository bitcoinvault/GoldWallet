...
- Latest checked on 2026-08-02: `react-native-camera-kit@18.0.0`, `react-native-permissions@5.6.1`, `react-native-vision-camera@5.2.1`, `react-native-qrcode-svg@6.3.21`, `react-native-svg@15.15.5`, and `qrcode@1.5.4`.
