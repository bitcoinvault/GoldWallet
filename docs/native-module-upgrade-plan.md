...
- `react-native-screens` is on checked latest `4.26.1` after `BEM-37.901`; the package satisfies the RN `0.86.0` baseline and keeps future changes tied to Android navigation smoke.
