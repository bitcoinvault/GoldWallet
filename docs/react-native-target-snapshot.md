...
- NPM snapshot date: `2026-08-11`
- Current repo React Native: `0.87.0`
...
- React peer for `react-native@0.87.0`: `^19.2.3`
- Node engine for `react-native@0.87.0`: `^22.13.0 || ^24.3.0 || >= 26.0.0`
- Latest live verification: `2026-08-11`
