...
| `@sentry/react-native` | `8.18.0` | `8.18.0` on 2026-07-11 | Latest checked SDK line; source-map and dSYM behavior must still be proven with local credentials. |
...
- Sentry SDK and CLI package targets remain current on 2026-07-11: `@sentry/react-native@8.18.0` and direct `@sentry/cli@3.6.0`.
