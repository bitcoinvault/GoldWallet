...
- Navigation/layout packages are on the RN `0.86.0` checkpoint versions: `@react-navigation/native@7.3.4`, `@react-navigation/stack@7.10.6`, `@react-navigation/bottom-tabs@7.18.3`, `@react-navigation/devtools@7.1.2`, `react-native-gesture-handler@3.0.2`, `react-native-screens@4.26.0`, and `react-native-safe-area-context@5.8.0`; future bumps should stay tied to navigation smoke validation.
