...
- Android dev environment audit verifies the local Java range, adb access, Gradle wrappers, Android validation scripts, and RN upgrade path audit scripts before build/smoke work.
