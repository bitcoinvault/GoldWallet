...
- Security resolution baselines after `BEM-37.863` through `BEM-37.871` pin patched transitive versions for `elliptic`, `cipher-base`, `sha.js`, `shell-quote`, `minimist`, Sentry CLI `undici`, `plist`, `simple-plist`, `braces`, `form-data`, `moment`, `qs`, `tmpl`, `tmp`, `joi@17.13.4`, `launch-editor@2.14.1`, `micromatch@4.0.8`, `protobufjs@7.6.5`, `word-wrap@1.2.5`, lockfile `brace-expansion@1.1.16`/`2.1.2`/`5.0.7`, lockfile `js-yaml@3.15.0`/`4.3.0`, lockfile `yaml@1.10.3`/`2.9.0`, and wallet-critical `tiny-secp256k1@2.2.4`, while the lockfile is guarded against vulnerable `ansi-regex`, `base-x@3.0.8`, `brace-expansion@1.1.11`, `minimatch@3.0.4`, `picomatch@2.3.0`, `lodash@4.17.21`, `jws@4.0.0`, `ws@7.5.4`, `tiny-secp256k1@1.1.6`, `joi@17.13.3`, `launch-editor@2.14.0`, `micromatch@4.0.4`, `protobufjs@7.6.1`/`7.6.2`, `word-wrap@1.2.3`, `js-yaml@3.14.1`, `js-yaml@4.1.1`, and `yaml@1.10.2` ranges. `BEM-37.868` keeps Android/RN runtime compatibility through a Metro-only `tiny-secp256k1` shim backed by `@bitcoinerlab/secp256k1`, because the upstream `tiny-secp256k1@2.2.4` browser entry imports WASM. `BEM-37.871` reduces `corepack yarn audit --json --level moderate` from `30` to `1` moderate finding; the remaining moderate owner path is `uuid`. `corepack yarn audit --json --level high` now reports `0` critical and `0` high findings, down from `22` critical and `148` high before the security branches.
