...
- Navigation/layout packages are on the RN `0.86.0` checkpoint versions checked on 2026-07-21: `@react-navigation/native@7.3.13`, `@react-navigation/stack@7.10.16`, `@react-navigation/bottom-tabs@7.18.13`, `@react-navigation/devtools@7.1.10`, `react-native-gesture-handler@3.1.0`, `react-native-screens@4.26.2`, and `react-native-safe-area-context@5.8.0`; future bumps should stay tied to navigation smoke validation.
