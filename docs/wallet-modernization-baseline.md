...
- Navigation/layout packages are on the RN `0.86.0` checkpoint versions: `react-native-gesture-handler@3.0.0`, `react-native-screens@4.25.2`, and `react-native-safe-area-context@5.8.0`; future bumps should stay tied to navigation smoke validation.
