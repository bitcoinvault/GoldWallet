...
- Android smoke helper writes `local-docs/android-smoke-dev-summary.txt` with outcome, exit code, selected serial, Metro endpoint/reachability, app PID, logcat count, UI attempts, and screenshot byte count
