...
- RN online baseline preflight runs the live npm target snapshot check, git dependency snapshot audit, node-fetch resolution audit, and summary validation before the normal offline RN baseline preflight.
