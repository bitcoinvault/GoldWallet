...
Latest local release build evidence refresh: on 2026-07-10, `feature/bem-37-832-android-release-evidence-refresh` rebuilt `devRelease`, `stageRelease`, `prodRelease`, and `betaRelease` with JDK 17, validated the generated release summary and APK manifests, and recorded release-input fingerprint `38811a1fc5979952bd4b67318360de3cc9960b75aa91a91f93dc62e28578d859` across `508` files. Unsigned release APK SHA-256 values are `dev` `cd7223b6ccb9cb45ad7f5f7fe22a705ca63f4932edc16f1653c1fcaf6d5589df`, `stage` `58fd3543f89eb93166164eb9fb8a31721609b6d51a5f4be264abd2533a4447ef`, `prod` `f732e52a0d4a6d36768be34d2d86f734866548661182f2bf502237e500921602`, and `beta` `91e59f3465abcb346a77ff0daf4b688a63fd7769d6d628c71b5b445dab84202e`; every variant generated release JS bundle SHA-256 `1bf05aa12f4211fef14cf8bbb790aaf47e8146420e3a867b6f32582138303fe5` and release source-map SHA-256 `adf9437a78ba85d5a782d5a04a1d6fec63835f23db0519c8a5efe4787e6711a8`. This proves release APK, bundle, source-map, and manifest generation only; Sentry source-map upload remains unclaimed without credentials, and this build-only refresh did not rerun release runtime smoke or release create-wallet proof. Latest full local release-smoke and release create-wallet evidence remains the 2026-06-23 `feature/bem-37-778-android-release-validation-refresh` run documented below, while the later controlled no-network release-smoke evidence remains a blocker classification only.

Latest controlled Android release no-network blocker evidence refresh: on 2026-07-10, `feature/bem-37-833-release-services-evidence-refresh` installed and launched the current locally signed `devRelease` APK on `emulator-5554`, completed first-run terms/PIN/transaction-password/email-skip, reached the expected external `No network` state, and refreshed `android-release-network-blocker-summary.txt` for the current APK SHA-256 values. The signed release-smoke APK SHA-256 was `81b6dc3431eba50f64cd901aa9a97fc7d4668c8411a73d62d3f776034f6d51b5`, sourced from unsigned `devRelease` APK SHA-256 `cd7223b6ccb9cb45ad7f5f7fe22a705ca63f4932edc16f1653c1fcaf6d5589df`. `release-services:check-summaries` passes only under `blocked-by-electrum-certificate-expired`; full dashboard, tab-navigation, QR scanner, Settings Terms WebView, release create-wallet, Firebase delivery, CodePush OTA, and Sentry upload validation remain unclaimed until the dev/testnet Electrum TLS certificate is fixed and the full release validation is rerun.
