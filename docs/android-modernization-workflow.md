...
Latest local release build evidence refresh: on 2026-07-11, `feature/bem-37-849-android-release-validation-refresh` rebuilt `devRelease`, `stageRelease`, `prodRelease`, and `betaRelease` with JDK 17, validated the generated release summary and APK manifests, and recorded release-input fingerprint `780b3b1e445deb523294515ef41944c85daef30642ec3b19c3aff5466a26ce8e` across `508` files. Unsigned release APK SHA-256 values are `dev` `4678ee6495ee8d9c8cf07e915e90233de0c99736de9519bf226ef70428fa2972`, `stage` `d7149b26a5e247e2fab2d393848710a0d463059addbbd30ff2728fe975fdc743`, `prod` `4e56cd2f9695375080bb905c31ecee3c719eeb23cf5ece7dd1ee625a73209b36`, and `beta` `b1ca35b14f01c00abed42af80a83b42cec26f271bf1c611fe6a62a38b1bdd0c4`; every variant generated release JS bundle SHA-256 `3f23fa25e44a2ba19f8b1cb004ed17a36d809eac892412388fc90192d174b9fd` and release source-map SHA-256 `dd08a0b5807a58510606be442a5b24fd3f868539b624830e2729d494cb2a0397`. This proves release APK, bundle, source-map, and manifest generation only; Sentry source-map upload remains unclaimed without credentials, and full dashboard/create-wallet release runtime proof remains blocked by the controlled Electrum certificate issue documented below.

Latest controlled Android release no-network blocker evidence refresh: on 2026-07-11, `feature/bem-37-849-android-release-validation-refresh` installed and launched the current locally signed `devRelease` APK on `emulator-5554`, completed first-run terms/PIN/transaction-password/email-skip, reached the expected external `No network` state, and refreshed `android-release-network-blocker-summary.txt` for the current APK SHA-256 values. The signed release-smoke APK SHA-256 was `4adb014c9791b3746ccc4310cfde132998f0536244a63c816665d10784f4f42e`, sourced from unsigned `devRelease` APK SHA-256 `4678ee6495ee8d9c8cf07e915e90233de0c99736de9519bf226ef70428fa2972`. The blocker remains `blocked-by-electrum-certificate-expired` for `electrumx.testnet.btcv.stage.rnd.land:443 tls`, expired `Tue Jun 23 16:52:40 GMT 2026` and compared during this run at `Sat Jul 11 16:33:32 GMT 2026`. `release-services:check-summaries` passes only under that controlled blocker; full dashboard, tab-navigation, QR scanner, Settings Terms WebView, release create-wallet, Firebase delivery, CodePush OTA, and Sentry upload validation remain unclaimed until the dev/testnet Electrum TLS certificate is fixed and the full release validation is rerun.

Latest Sentry release preflight evidence refresh: on 2026-07-10, `feature/bem-37-835-sentry-release-prereq-refresh` revalidated `@sentry/react-native@8.18.0` and direct `@sentry/cli@3.6.0` as current npm latest targets after the latest Android release build, controlled no-network release smoke, and iOS static evidence refreshes. Full release smoke and release create-wallet smoke remain blocked by the dev/testnet `No network` screen, but the reduced `android-smoke-dev-release-no-network` proof is valid for signed `devRelease` install, launch, onboarding, expected `No network` UI, and no fatal/runtime logcat findings. `sentry:release:validation:preflight` may pass in that controlled `not ready` state only with a classified Electrum certificate blocker; it still keeps Sentry source-map upload unclaimed until `SENTRY_AUTH_TOKEN`, root/Android/iOS `sentry.properties`, macOS/Xcode/CocoaPods iOS validation, zero active `ios/Podfile.lock` drift, and full release smoke/create-wallet evidence are available.
