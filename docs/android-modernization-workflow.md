...
Latest local release build and release-smoke evidence refresh: on 2026-06-23, `feature/bem-37-766-android-release-validation-refresh` rebuilt `devRelease`, `stageRelease`, `prodRelease`, and `betaRelease` with JDK 17, validated the generated release summary and APK manifests, fixed the manifest checker so subset runs respect `ANDROID_RELEASE_VARIANTS`, installed a locally signed `devRelease` smoke APK on `emulator-5554` without Metro, completed first-run terms/PIN/transaction-password setup, validated empty-dashboard CTA navigation, tab navigation, QR scanner, Settings Terms WebView, then ran release create-wallet smoke through standard-wallet mnemonic backup and default 3-key vault public-key integration screens. The release-input fingerprint was `8234531312a92f8c93db6f839061f7501d0996c973478041f8dca51d982acae5` across `508` files, the unsigned `devRelease` APK SHA-256 was `9662c3faa16284c9cc66d165640f366dfde2c28f17b787586e680df2eb837829`, the signed release-smoke APK SHA-256 was `ceb6017d645f24a9cecaf722f6fda29de1143e2864e68f783b73bf79339a088b`, and no fatal/runtime logcat findings were reported. Earlier `feature/bem-37-740-secure-storage-release-evidence-refresh`, `feature/bem-37-735-sentry-release-evidence-refresh`, `feature/bem-37-725-android-release-validation-refresh`, `feature/bem-37-715-android-release-evidence-refresh`, `feature/bem-37-590-android-release-evidence-refresh`, `feature/bem-37-645-android-release-evidence-refresh`, `feature/bem-37-646-android-release-smoke-refresh`, and `feature/bem-37-671-android-release-evidence-refresh` established the release-input fingerprint and aggregate release-services evidence pattern after the RN `0.86.0` foundation. Keep future release proof branches on the same summary/checker flow so APK evidence stays local while the tracked log records the milestone.
