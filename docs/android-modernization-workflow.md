...
Latest local release build evidence refresh: on 2026-06-24, `feature/bem-37-786-release-services-evidence-refresh` rebuilt `devRelease`, `stageRelease`, `prodRelease`, and `betaRelease` with JDK 17, validated the generated release summary and APK manifests, and recorded release-input fingerprint `1495c7e166f978506bf8a007c8b9645efc5546a89d9ab04c129e5f4ef6307a74` across `508` files. The unsigned `devRelease` APK SHA-256 was `77988961a23cc2120d80eff33b8d056968417a5b8d497585495a6002d10b8650`, and the locally signed release-smoke APK SHA-256 was `2ae43e7cbfcca886678ef4b3d53b40499f9ce75ac3389daed61999d6adfc4bf7`. Full release-smoke and release create-wallet evidence are not current for that branch because the dev/testnet Electrum path reached `No network` with logcat `SSLHandshakeException` caused by `CertificateExpiredException: Certificate expired at Tue Jun 23 16:52:40 GMT 2026`; a reduced release smoke validated install, launch, onboarding, expected `No network` UI, and no fatal/runtime logcat findings only. Keep `release-services:check-summaries` red in this state; do not treat reduced `No network` evidence as equivalent to empty-dashboard CTA, tab-navigation, QR scanner, Settings Terms WebView, or create-wallet release proof.
