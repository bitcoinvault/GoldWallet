...
- The latest npm releases checked for the Sentry release path on 2026-05-31 are `@sentry/react-native@8.13.0` and `@sentry/cli@3.4.3`, so there is no package bump to take on the current RN `0.85.3` baseline.
