...
- `react-native-gesture-handler@2.29.1` is the highest compatible version validated with the RN `0.85.3` New Architecture baseline; `3.0.0` failed Android Kotlin/codegen compilation during the RN `0.85.3` proof.
