...
- Current navigation packages: `@react-navigation/native@7.3.14`, `@react-navigation/stack@7.10.17`, `@react-navigation/bottom-tabs@7.18.14`, and `@react-navigation/devtools@7.1.11`.
- `@react-navigation/stack@7.10.17` no longer requires `@react-native-community/masked-view`.
