...
- Security transitive baselines are guarded after `BEM-37.863` through `BEM-37.865`: `elliptic@6.6.1`, `cipher-base@1.0.7`, `sha.js@2.4.12`, `shell-quote@1.10.0`, `minimist@1.2.8`, Sentry CLI `undici@6.27.0`, `plist@3.1.1`, `simple-plist@1.3.1`, `braces@3.0.3`, `form-data@4.0.6`, `moment@2.30.1`, `qs@6.15.3`, `tmpl@1.0.5`, lockfile `ansi-regex`, lockfile `minimatch@3.1.5`, and lockfile `picomatch@2.3.2`. The security branches reduced `corepack yarn audit --json --level high` from `22` critical / `148` high to `0` critical / `28` high; remaining high findings need separate owner-path branches rather than unscoped overrides, with wallet-critical `tiny-secp256k1` and `base-x` kept for a dedicated crypto compatibility branch.
