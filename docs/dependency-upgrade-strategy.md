...
- Babel `8.x` is recorded as blocked after `BEM-37.681` because RN `0.86.0` still ships a Babel preset dependency stack on Babel `7.x` plugins. Treat Babel 8 as a dedicated RN/Metro/Babel migration branch, not as a direct package patch.
