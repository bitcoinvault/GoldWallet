...
- Small tooling patch cohort is refreshed through `BEM-37.681`: `@types/react@19.2.17`, `@typescript-eslint/eslint-plugin@8.61.1`, `@typescript-eslint/parser@8.61.1`, `eslint@10.5.0`, `detox@20.51.4`, `prettier@3.8.4`, `semver@7.8.4`, and `junit-report-merger@9.0.4`.
