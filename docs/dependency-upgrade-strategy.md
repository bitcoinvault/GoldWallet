...
- The Sentry release-services baseline is current after BEM-37.935: `@sentry/react-native@8.21.0`, direct `@sentry/cli@3.6.2`, and Sentry-scoped `undici@8.9.0`. Future work in this owner path must preserve full release/source-map generation, production emulator smoke, and secret-safe credential gating.
