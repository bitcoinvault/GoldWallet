...
- Security transitive baselines are guarded after `BEM-37.863` through `BEM-37.870`: `elliptic@6.6.1`, `cipher-base@1.0.7`, `sha.js@2.4.12`, `shell-quote@1.10.0`, `minimist@1.2.8`, Sentry CLI `undici@6.27.0`, `plist@3.1.1`, `simple-plist@1.3.1`, `braces@3.0.3`, `form-data@4.0.6`, `moment@2.30.1`, `qs@6.15.3`, `tmpl@1.0.5`, `tmp@0.2.7`, `joi@17.13.4`, `launch-editor@2.14.1`, `micromatch@4.0.8`, `protobufjs@7.6.5`, `word-wrap@1.2.5`, lockfile `ansi-regex`, lockfile `base-x@3.0.11`, lockfile `brace-expansion@1.1.16`/`2.1.2`/`5.0.7`, lockfile `minimatch@3.1.5`, lockfile `picomatch@2.3.2`, lockfile `lodash@4.18.1`, lockfile `jws@4.0.1`, lockfile `ws@7.5.11`, and wallet-critical `tiny-secp256k1@2.2.4`. `BEM-37.868` keeps React Native runtime compatibility through a Metro-only `tiny-secp256k1` shim backed by `@bitcoinerlab/secp256k1`, because the upstream browser entry imports WASM. `BEM-37.870` reduces the remaining moderate audit surface from `43` to `30` findings; the remaining moderate owner paths are `js-yaml`, `yaml`, and `uuid`, which require dedicated owner-path review. The security branches reduced `corepack yarn audit --json --level high` from `22` critical / `148` high to `0` critical / `0` high.
