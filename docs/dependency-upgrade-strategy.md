...
- Localization runtime is on checked latest `i18next@26.3.6` and `react-i18next@17.0.10` after `BEM-37.925`; `react-i18next` accepts `i18next >=26.2.0`, React `>=16.8.0`, and TypeScript 5/6/7.
