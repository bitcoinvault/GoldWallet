...
- `@typescript-eslint@8.62.0` and `lint-staged@17.0.8` are now the lint/tooling baselines after precommit, lint-staged, TypeScript, and baseline-audit proof. Future patch drift in this cohort still needs a dedicated lint/tooling branch before changing the baseline snapshot.
