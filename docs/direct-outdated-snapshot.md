...
- Security transitive resolutions are pinned and guarded after `BEM-37.863`: `elliptic@6.6.1`, `cipher-base@1.0.7`, `sha.js@2.4.12`, `shell-quote@1.10.0`, `minimist@1.2.8`, Sentry CLI `undici@6.27.0`, `plist@3.1.1`, and `simple-plist@1.3.1`. Future security drift should use `corepack yarn check:security-resolution-baselines` and a dedicated owner-path branch instead of unscoped overrides.
