...
- `caniuse-lite@1.0.30001803` is pinned through `resolutions`; live npm metadata on `2026-07-11` reports `1.0.30001805`, and that Browserslist data drift remains blocked until a dedicated tooling/resolution branch updates the lockfile and proves baseline audit plus bundle-transform behavior.
