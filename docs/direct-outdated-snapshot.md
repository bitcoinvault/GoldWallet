...
- `react-native-screens@4.25.2` remains a native navigation baseline; current patch drift to `4.26.0` needs a dedicated navigation/native-screens branch with stack/tab navigation and Android emulator proof instead of being mixed into unrelated release-services work.
