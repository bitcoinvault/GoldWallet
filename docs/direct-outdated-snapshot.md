...
- Security transitive resolutions are pinned and guarded after `BEM-37.863` and `BEM-37.864`: `elliptic@6.6.1`, `cipher-base@1.0.7`, `sha.js@2.4.12`, `shell-quote@1.10.0`, `minimist@1.2.8`, Sentry CLI `undici@6.27.0`, `plist@3.1.1`, `simple-plist@1.3.1`, `braces@3.0.3`, `form-data@4.0.6`, `moment@2.30.1`, `qs@6.15.3`, and `tmpl@1.0.5`; vulnerable `ansi-regex` ranges are guarded through lockfile versions. Future security drift should use `corepack yarn check:security-resolution-baselines` and a dedicated owner-path branch instead of unscoped overrides.
