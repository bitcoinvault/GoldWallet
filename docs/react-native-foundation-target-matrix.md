...
- npm `react-native@nightly`: `0.87.0-nightly-20260624-5c197fb30`
- `react-native@0.86.0` peer React: `^19.2.3`
- `react-native@0.86.0` Node engine: `^20.19.4 || ^22.13.0 || ^24.3.0 || >= 25.0.0`
- Snapshot recorded: `2026-06-24`
- Latest live verification: `2026-06-24`, outcome `matched`, mismatches `0`
...
- It records AGP `9.2.1`, Gradle `9.6.0`, stable Kotlin `2.4.0`, and Kotlin metadata release `2.4.20-Beta1` as not yet adoptable because the React Native Gradle plugin `0.86.0` path cannot compile through the Gradle 9 embedded Kotlin metadata path. The direct Gradle `9.6.0` probe failed in `:gradle-plugin:settings-plugin:compileKotlin` while compiling `ReactSettingsExtension.kt`.
