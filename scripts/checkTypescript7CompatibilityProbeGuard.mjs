...
const validSummary = [
  ...
  '- @typescript-eslint/parser: package 8.67.0, latest 8.67.0, TypeScript peer >=4.8.4 <6.1.0, target compatible no',
  '- @typescript-eslint/eslint-plugin: package 8.67.0, latest 8.67.0, TypeScript peer >=4.8.4 <6.1.0, target compatible no',
  ...
  '- @typescript-eslint/parser: installed 8.67.0, TypeScript peer >=4.8.4 <6.1.0, target compatible no',
  '- @typescript-eslint/eslint-plugin: installed 8.67.0, TypeScript peer >=4.8.4 <6.1.0, target compatible no',
