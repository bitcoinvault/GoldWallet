...
const validSummary = [
  ...
  '- @typescript-eslint/parser: package 8.65.0, latest 8.65.0, TypeScript peer >=4.8.4 <6.1.0, target compatible no',
  '- @typescript-eslint/eslint-plugin: package 8.65.0, latest 8.65.0, TypeScript peer >=4.8.4 <6.1.0, target compatible no',
  '- ts-jest: package 29.4.12, latest 29.4.12, TypeScript peer >=4.3 <7, target compatible no',
  ...
  '- @typescript-eslint/parser: installed 8.65.0, TypeScript peer >=4.8.4 <6.1.0, target compatible no',
  '- @typescript-eslint/eslint-plugin: installed 8.65.0, TypeScript peer >=4.8.4 <6.1.0, target compatible no',
  '- ts-jest: installed 29.4.12, TypeScript peer >=4.3 <7, target compatible no',
