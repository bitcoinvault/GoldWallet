...
export const expectedReactNativeBaselinePreflight =
  'yarn check:node-runtime-version && yarn android:dev:check-light && yarn metro:dev-runtime:audit && yarn check:node-runtime-transition-guard && yarn node:runtime-transition:audit && yarn lint-staged:tooling:audit && yarn husky:tooling:audit && yarn prettier:tooling:audit && yarn jest:tooling:audit && yarn upgrade:strategy:audit && yarn rn:upgrade-path:audit && yarn rn:076-foundation:audit && yarn check:foundation-target-summary-guard && yarn check:rn-target-snapshot-guard && yarn check:rn-target-snapshot-current-guard && yarn rn:target-snapshot:audit && yarn check:react19-impact-guard && yarn react19:impact:audit && yarn check:react-package-coupling-guard && yarn react:package-coupling:audit && yarn check:react-renderer-version-guard && yarn react:renderer-version:audit && yarn check:test-type-coupling-guard && yarn test:type-coupling:audit && yarn check:detox-readiness && yarn wallet:crypto-runtime:audit && yarn crypto-js:runtime:audit && yarn state:runtime:audit && yarn lodash:runtime:audit && yarn check:wallet-crypto-latest-snapshot-summary-guard && yarn check:direct-outdated-snapshot-summary-guard && yarn camera:candidate:audit && yarn camera:candidate:check-summary && yarn camera:qr-migration:audit && yarn camera:qr-migration:check-summary && yarn check:camera-qr-validation-handoff-guard && yarn camera:qr-validation:handoff:dry-run && yarn masked-view:migration:audit && yarn masked-view:migration:check-summary && yarn check:secure-storage-release-validation-handoff-guard && yarn secure-storage:migration:audit && yarn secure-storage:migration:check-summary && yarn secure-storage:removal-readiness:audit && yarn secure-storage:removal-readiness:check-summary && yarn check:explorer-env-config-readiness-guard && yarn check:explorer-env-config-readiness && yarn check:store-metadata-readiness-guard && yarn check:store-metadata-readiness && yarn sentry:android-warning:audit && yarn sentry:android-warning:check-summary && yarn sentry:rn-bundle-task-compat:audit && yarn sentry:rn-bundle-task-compat:check-summary && yarn check:android-warning-source-summaries-guard && yarn android:dev:check-warning-source-summaries && yarn check:android-warning-audit-summary-guard && yarn android:dev:check-warning-audit-summary && yarn check:android-smoke-summary-guard && yarn android:dev:check-smoke-summary && yarn check:sentry-properties-generator && yarn check:sentry-release-validation-handoff-guard && yarn check:sentry-credential-handoff-guard && yarn sentry:release:prereq-audit && yarn sentry:release:prereq-check-summary && yarn firebase:release-services:audit && yarn firebase:release-services:check-summary && yarn check:firebase-runtime-delivery-handoff-guard && yarn firebase:runtime:delivery:handoff:dry-run --skip-android-release && yarn check:codepush-update-validation-handoff-guard && yarn codepush:update:validation:handoff:dry-run --skip-android-release && yarn codepush:release:path-audit && yarn codepush:release:path-check-summary && yarn codepush:migration:readiness-audit && yarn codepush:migration:readiness-check-summary && yarn codepush:removal-readiness:audit && yarn codepush:removal-readiness:check-summary && yarn check:codepush-decision-handoff-guard && yarn codepush:decision:handoff:dry-run && yarn check:codepush-decision-handoff-summary-guard && yarn push-notification:bridge-audit && yarn push-notification:bridge-check-summary && yarn check:ios-release-readiness-audit-guard && yarn check:ios-release-readiness-summary-guard && yarn ios:release:readiness:audit && yarn ios:release:readiness:check-summary && yarn check:ios-mac-validation-prereq-summary-guard && yarn ios:mac-validation-prereq:audit && yarn ios:mac-validation-prereq:check-summary && yarn check:ios-mac-validation-handoff-guard && yarn check:ios-validation-handoff-summary-guard && yarn ios:validation:handoff-summary:dry-run && yarn check:android-release-apk-manifest-guard && yarn check:release-services-validation-handoff-guard && yarn check:release-services-summary-guard && yarn release-services:check-summaries';
