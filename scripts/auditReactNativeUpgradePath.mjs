...
export const requiredReactNativeUpgradePathSnippets = [
  ['docs/react-native-upgrade-path.md', 'React Native: `0.81.6`'],
  ['docs/react-native-upgrade-path.md', 'React: `19.1.4`'],
  ['docs/react-native-upgrade-path.md', 'RN Babel preset: `0.81.6`'],
  ['docs/react-native-upgrade-path.md', 'RN Metro config: `0.81.6`'],
  ...
  ['docs/react-native-upgrade-path.md', 'Current milestone targets are `0.81.6`, then `0.82.x`, then the current `0.85.x` line'],
  ...
  ['docs/dependency-upgrade-strategy.md', 'Try the latest target first when the change is feasible'],
  ['docs/react-native-076-foundation-plan.md', 'react-native@0.81.6'],
  ...
  ['docs/react-native-foundation-target-matrix.md', 'Milestone A: RN 0.81.6 Foundation'],
  ...
  ['docs/wallet-modernization-baseline.md', 'continue with milestone jumps from RN `0.81.6` toward a current supported line'],
  ['docs/wallet-modernization-baseline.md', 'Continue RN with milestone jumps from `0.81.6` toward newer supported lines'],
