...
export const getCameraCandidateSummaryErrors = summary => {
  ...
  if (metadataCheckedOn !== '2026-07-10') {
    errors.push(`Metadata checked on must be 2026-07-10. Received: ${metadataCheckedOn || 'missing'}`);
  }
  ...
  if (visionCamera !== 'react-native-vision-camera@5.1.0') {
    errors.push(`VisionCamera latest must be react-native-vision-camera@5.1.0. Received: ${visionCamera || 'missing'}`);
  }
