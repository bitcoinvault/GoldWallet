...
const requiredSnippets = [
  ...
  'Full release, create-wallet, and import-wallet runtime proof remain unclaimed until the dev/testnet Electrum TLS certificate is fixed.',
  ...
  'getAndroidImportWalletSmokeSummaryErrors(summary, {',
...
const expectedArtifacts = [
  ...
  ['Android release smoke', 'local-docs/android-smoke-prod-release-summary.txt'],
  ['Android release create-wallet smoke', 'local-docs/android-create-wallet-smoke-prod-release-summary.txt'],
  ['Android release import-wallet smoke', 'local-docs/android-import-wallet-smoke-prod-release-summary.txt'],
  ['Sentry release prerequisite', 'local-docs/sentry-release-prereq-summary.txt'],
  ['Sentry release credential plan', 'local-docs/sentry-release-credential-plan.txt'],
  ['Sentry release validation handoff', 'local-docs/sentry-release-validation-handoff-summary.txt'],
  ...
  ['CodePush update validation handoff', 'local-docs/codepush-update-validation-handoff-summary.txt'],
