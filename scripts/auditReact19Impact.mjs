...
export const requiredReact19ImpactSnippets = [
  ...
  ['docs/react19-impact-audit.md', 'Current React types: `19.2.16`'],
...
export const getReact19ImpactIssues = ({ dependencies, devDependencies, scripts, docs, existingDocs, inventory }) => {
  ...
  if (devDependencies['@types/react'] !== '19.2.16') {
    errors.push(`package.json has @types/react@${devDependencies['@types/react'] || '<missing>'}; expected current React types baseline 19.2.16`);
  }
