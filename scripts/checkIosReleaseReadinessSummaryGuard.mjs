...
const currentPodfileLockDriftLines = [
  ...
  '- ios/Podfile.lock has RNScreens 3.6.0; package.json has react-native-screens 4.26.1',
...
assertRejected(
  ...
  removeDriftLine('- ios/Podfile.lock has RNSentry 3.1.0; package.json has @sentry/react-native 8.18.0'),
  'RNSentry 3.1.0',
);
assertRejected(
