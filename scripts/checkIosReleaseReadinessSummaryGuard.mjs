...
const currentPodfileLockDriftLines = [
  ...
  '- ios/Podfile.lock has RNFBApp 12.7.5; package.json has @react-native-firebase/app 24.1.1',
  '- ios/Podfile.lock has RNGestureHandler 1.10.3; package.json has react-native-gesture-handler 3.0.1',
...
assertRejected(
  ...
  validWindowsSummary.replace('React Native version: 0.86.0', 'React Native version: 0.84.0'),
...
assertRejected(
  ...
  removeDriftLine('- ios/Podfile.lock has RNFBApp 12.7.5; package.json has @react-native-firebase/app 24.1.1'),
  'RNFBApp 12.7.5',
);
assertRejected(
  'Missing Sentry pod drift fixture',
  removeDriftLine('- ios/Podfile.lock has RNSentry 3.1.0; package.json has @sentry/react-native 8.14.0'),
  'RNSentry 3.1.0',
);
assertRejected(
