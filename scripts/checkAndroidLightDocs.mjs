...
const requiredCheckLightScripts = [
  ...
  'check:appcenter-retirement-guard',
  'check:appcenter-retirement',
  'check:firebase-usage-guard',
  'check:firebase-usage-scope',
  'check:firebase-messaging-modular-usage-guard',
  'check:firebase-messaging-modular-usage',
  ...
  'check:ios-release-config-doc-guard',
  ...
  'check:electrum-endpoint-readiness-guard',
  'check:electrum-certificate-workflow-guard',
  'check:github-security-workflows-guard',
  'check:electrum-runtime-observation-parser-guard',
  'check:electrum-metro-observation-path-guard',
  ...
  'check:bl-resolution-summary-guard',
  'check:bl-resolution-current',
...
const docs = [
  {
    ...
    terms: [
      ...
      'Electrum endpoint readiness guard',
      'Electrum certificate workflow guard',
      'GitHub security workflow guard',
      'Electrum runtime observation parser guard',
      'Electrum Metro observation path guard',
  ...
  },
  {
    ...
    terms: [
      ...
      'App Center retirement guard self-check',
      ...
      'check:sentry-release-integration',
      'Sentry candidate evidence guard self-check',
      ...
      'BL resolution guard self-check',
      'BL current resolution check',
