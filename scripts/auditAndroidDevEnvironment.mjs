...
export const requiredAndroidDevFiles = [
  ...
  ['scripts/directOutdatedSnapshotSummaryGuard.mjs', 'direct outdated snapshot summary guard helper'],
  ['scripts/auditDirectOutdatedSnapshot.mjs', 'direct outdated snapshot audit helper'],
  ['scripts/checkDirectOutdatedSnapshotSummary.mjs', 'direct outdated snapshot summary artifact checker'],
  ['scripts/checkDirectOutdatedSnapshotSummaryGuard.mjs', 'direct outdated snapshot summary guard self-check helper'],
  ['scripts/walletCryptoLatestSnapshotSummaryGuard.mjs', 'wallet crypto latest snapshot summary guard helper'],
  ['scripts/auditWalletCryptoLatestSnapshot.mjs', 'wallet crypto latest snapshot audit helper'],
  ['scripts/checkWalletCryptoLatestSnapshotSummary.mjs', 'wallet crypto latest snapshot summary artifact checker'],
  ['scripts/checkWalletCryptoLatestSnapshotSummaryGuard.mjs', 'wallet crypto latest snapshot summary guard self-check helper'],
  ['scripts/storageNetworkLatestSnapshotSummaryGuard.mjs', 'storage/network latest snapshot summary guard helper'],
  ['scripts/auditStorageNetworkLatestSnapshot.mjs', 'storage/network latest snapshot audit helper'],
  ['scripts/checkStorageNetworkLatestSnapshotSummary.mjs', 'storage/network latest snapshot summary artifact checker'],
  ['scripts/checkStorageNetworkLatestSnapshotSummaryGuard.mjs', 'storage/network latest snapshot summary guard self-check helper'],
  ...
  ['scripts/auditReactNativeRendererVersion.mjs', 'React Native renderer exact-version audit helper'],
  ['scripts/checkReactNativeRendererVersionGuard.mjs', 'React Native renderer exact-version guard helper'],
  ...
  ['scripts/runSecureStorageReleaseValidationHandoff.mjs', 'secure-storage release validation handoff helper'],
  ['scripts/checkSecureStorageReleaseValidationHandoffGuard.mjs', 'secure-storage release validation handoff guard self-check helper'],
  ...
  ['scripts/codePushEnvCleanupReadinessSummaryGuard.mjs', 'CodePush env cleanup readiness summary guard helper'],
  ['scripts/auditCodePushEnvCleanupReadiness.mjs', 'CodePush env cleanup readiness audit helper'],
  ['scripts/checkCodePushEnvCleanupReadinessSummary.mjs', 'CodePush env cleanup readiness summary artifact checker'],
  ['scripts/checkCodePushEnvCleanupReadinessSummaryGuard.mjs', 'CodePush env cleanup readiness summary guard self-check helper'],
  ['scripts/codePushEnvCleanupPlanGuard.mjs', 'CodePush env cleanup plan guard helper'],
  ['scripts/planCodePushEnvCleanup.mjs', 'CodePush env cleanup plan helper'],
  ['scripts/checkCodePushEnvCleanupPlan.mjs', 'CodePush env cleanup plan artifact checker'],
  ['scripts/checkCodePushEnvCleanupPlanGuard.mjs', 'CodePush env cleanup plan guard self-check helper'],
...
export const requiredAndroidDevPackageScripts = [
  ...
  'direct-outdated:snapshot:audit',
  'direct-outdated:snapshot:check-summary',
  'check:direct-outdated-snapshot-summary-guard',
  'wallet:crypto-latest-snapshot:audit',
  'wallet:crypto-latest-snapshot:check-summary',
  'check:wallet-crypto-latest-snapshot-summary-guard',
  'storage-network:latest-snapshot:audit',
  'storage-network:latest-snapshot:check-summary',
  'check:storage-network-latest-snapshot-summary-guard',
  ...
  'secure-storage:release-validation:handoff',
  'secure-storage:release-validation:handoff:dry-run',
  'check:secure-storage-release-validation-handoff-guard',
  ...
  'codepush:env-cleanup:audit',
  'codepush:env-cleanup:check-summary',
  'check:codepush-env-cleanup-summary-guard',
  'codepush:env-cleanup:plan',
  'codepush:env-cleanup:check-plan',
  'check:codepush-env-cleanup-plan-guard',
