...
const validSummary = [
  ...
  '- @typescript-eslint/eslint-plugin: package 8.62.1, installed 8.62.1, latest 8.62.1, decision current - parser/plugin pair verified through the ESLint 10 flat-config bridge',
  '- @typescript-eslint/parser: package 8.62.1, installed 8.62.1, latest 8.62.1, decision current - parser/plugin pair verified through the ESLint 10 flat-config bridge',
  '- eslint: package 10.6.0, installed 10.6.0, latest 10.6.0, decision current - latest ESLint 10 runtime verified through eslint.config.mjs while preserving the existing lint baseline',
  ...
  '- prettier: package 3.9.4, installed 3.9.4, latest 3.9.4, decision current - latest Prettier 3 formatting runtime verified against the existing lint baseline without mass formatting',
