...
const validSummary = [
  ...
  '- @typescript-eslint/eslint-plugin: package 8.67.0, installed 8.67.0, latest 8.67.0, decision current - parser/plugin pair verified through the ESLint 10 flat-config bridge',
  '- @typescript-eslint/parser: package 8.67.0, installed 8.67.0, latest 8.67.0, decision current - parser/plugin pair verified through the ESLint 10 flat-config bridge',
  '- eslint: package 10.8.1, installed 10.8.1, latest 10.8.1, decision current - latest ESLint 10 runtime verified through eslint.config.mjs while preserving the existing lint baseline',
  ...
  '- @eslint/eslintrc: package 3.3.6, installed 3.3.6, latest 3.3.6, decision current - latest FlatCompat package used to bridge the legacy .eslintrc baseline into ESLint 10',
  ...
  '- prettier: package 3.9.6, installed 3.9.6, latest 3.9.6, decision current - latest Prettier 3 formatting runtime verified against the existing lint baseline without mass formatting',
  ...
  '- lint-staged: package 17.3.0, installed 17.3.0, latest 17.3.0, decision current - latest lint-staged verified on the Node 24 tooling baseline',
...
assertRejected(
  ...
  validSummary.replace(
    '- lint-staged: package 17.3.0, installed 17.3.0, latest 17.3.0, decision current - latest lint-staged verified on the Node 24 tooling baseline',
    '- lint-staged: package 17.3.0, installed 17.1.0, latest 17.3.0, decision current - latest lint-staged verified on the Node 24 tooling baseline',
  ),
