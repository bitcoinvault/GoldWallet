...
const validSummary = [
  ...
  '- @typescript-eslint/eslint-plugin: package 8.63.0, installed 8.63.0, latest 8.63.0, decision current - parser/plugin pair verified through the ESLint 10 flat-config bridge',
  '- @typescript-eslint/parser: package 8.63.0, installed 8.63.0, latest 8.63.0, decision current - parser/plugin pair verified through the ESLint 10 flat-config bridge',
