...
const validSummary = [
  ...
  '- eslint: package 10.8.0, installed 10.8.0, latest 10.8.0, decision current - latest ESLint 10 runtime verified through eslint.config.mjs while preserving the existing lint baseline',
