...
const validSummary = [
  ...
  '- lint-staged: package 17.1.0, installed 17.1.0, latest 17.1.0, decision current - latest lint-staged verified on the Node 24 tooling baseline',
...
assertRejected(
  ...
  validSummary.replace(
    '- lint-staged: package 17.1.0, installed 17.1.0, latest 17.1.0, decision current - latest lint-staged verified on the Node 24 tooling baseline',
    '- lint-staged: package 17.1.0, installed 17.0.8, latest 17.1.0, decision current - latest lint-staged verified on the Node 24 tooling baseline',
  ),
