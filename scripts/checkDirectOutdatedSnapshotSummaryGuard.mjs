...
assertRejected(
  ...
  validSummary.replace(
    'Secret values printed: no',
    '- react-native-gesture-handler: current 3.0.0, wanted 3.0.0, latest 3.0.1, type dependencies, decision blocked - gesture runtime patch drift requires generic patch update before bumping\nSecret values printed: no',
  ),
