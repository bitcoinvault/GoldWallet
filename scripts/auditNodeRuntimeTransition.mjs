...
export const requiredNodeRuntimeTransitionSnippets = [
  ...
  ['docs/node-runtime-transition-audit.md', 'Current React Native: `0.81.6`'],
  ['docs/node-runtime-transition-audit.md', 'Current RN Babel preset: `0.81.6`'],
  ['docs/node-runtime-transition-audit.md', 'Current RN Metro config: `0.81.6`'],
