...
export const requiredNodeRuntimeTransitionSnippets = [
  ...
  ['docs/node-runtime-transition-audit.md', 'Current React Native: `0.86.0`'],
  ['docs/node-runtime-transition-audit.md', 'Current RN Babel preset: `0.86.0`'],
  ['docs/node-runtime-transition-audit.md', 'Current RN Metro config: `0.86.0`'],
  ['docs/node-runtime-transition-audit.md', 'Target React Native snapshot: `0.86.0`'],
  ['docs/node-runtime-transition-audit.md', 'Target RN Node engine snapshot: `^20.19.4 || ^22.13.0 || ^24.3.0 || >= 25.0.0`'],
  ['docs/node-runtime-transition-audit.md', 'Keep `.nvmrc` on `24.16.0` for the RN 0.86.0 foundation checkpoint and Node 24 tooling baseline.'],
