...
const badCountSummary = validSummary.replace('Targeted Android Gradle warnings: 3', 'Targeted Android Gradle warnings: 2');
...
assertRejected('Mismatched warning count fixture', badCountSummary, 'Targeted Android Gradle warnings must be 3');
