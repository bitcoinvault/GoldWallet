...
const badCountSummary = validSummary.replace('Targeted Android Gradle warnings: 5', 'Targeted Android Gradle warnings: 4');
...
assertRejected('Mismatched warning count fixture', badCountSummary, 'Targeted Android Gradle warnings must be 5');
