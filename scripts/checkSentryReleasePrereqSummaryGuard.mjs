...
const notReadySummary = [
  ...
  '@sentry/react-native version: 8.22.0',
  '@sentry/react-native latest: 8.22.0',
  '@sentry/react-native highest published: 8.22.0',
...
assertRejected(
  ...
  notReadySummary.replace('@sentry/react-native version: 8.22.0', '@sentry/react-native version: missing'),
  '@sentry/react-native version must be present',
);
assertRejected(
  'Missing Sentry SDK latest fixture',
  notReadySummary.replace('@sentry/react-native latest: 8.22.0', '@sentry/react-native latest: missing'),
...
assertRejected(
  ...
  'SENTRY_ORG/platform project overrides',
);
assertRejected(
  'Missing Sentry project override fixture',
  notReadySummary.replace(
    'create-sentry-properties.sh supports platform project overrides: yes',
    'create-sentry-properties.sh supports platform project overrides: no',
  ),
  'SENTRY_ORG/platform project overrides',
);
assertRejected(
