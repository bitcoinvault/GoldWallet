...
export const formatBabel8MigrationProbeSummary = (audit, generatedAt = new Date().toISOString()) =>
  [
    ...
    'Required action: keep Babel 8 blocked on RN 0.87.0 until a dedicated RN/Metro/Babel branch proves the transform, Jest, Metro bundle, Android build, and emulator smoke paths.',
    '',
  ].join('\n');
