...
export const requiredReactPackageCouplingSnippets = [
  ...
  ['docs/react-package-coupling-audit.md', 'corepack yarn react:patch-blocker:audit'],
  ['docs/react-package-coupling-audit.md', 'corepack yarn react:patch-blocker:check-summary'],
...
export const getReactPackageCouplingIssues = ({ dependencies, devDependencies, resolutions, scripts, docs, existingDocs }) => {
  ...
  if (devDependencies['@types/react-native']) {
    errors.push(
      `package.json has @types/react-native@${devDependencies['@types/react-native']}; expected React Native types to be bundled with react-native@0.87.0`,
    );
  }
