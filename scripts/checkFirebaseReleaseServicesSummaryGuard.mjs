...
const validSummary = [
  ...
  'React Native Firebase package version set: 25.0.1',
  'React Native Firebase latest version: 25.0.1',
  'React Native Firebase latest published at: 2026-06-23T18:03:05.274Z',
  'React Native Firebase npm repository: git+https://github.com/invertase/react-native-firebase.git#main',
  'React Native Firebase Messaging latest version: 25.0.1',
  'React Native Firebase Messaging peer app version: 25.0.1',
...
assertRejected('Missing latest Firebase fixture', validSummary.replace('React Native Firebase latest version: 25.0.1', 'React Native Firebase latest version: missing'), 'latest version');
assertRejected(
  'Missing latest publish timestamp fixture',
  validSummary.replace('React Native Firebase latest published at: 2026-06-23T18:03:05.274Z', 'React Native Firebase latest published at: missing'),
  'published timestamp',
);
assertRejected(
...
assertRejected(
  ...
  validSummary.replace('React Native Firebase Messaging latest version: 25.0.1', 'React Native Firebase Messaging latest version: 23.0.0'),
  'Messaging latest version',
);
assertRejected(
  'Messaging peer mismatch fixture',
  validSummary.replace('React Native Firebase Messaging peer app version: 25.0.1', 'React Native Firebase Messaging peer app version: 23.0.0'),
