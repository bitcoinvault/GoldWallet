...
const validSummary = [
  ...
  'React Native Firebase package version set: 26.2.0',
  'React Native Firebase latest version: 26.2.0',
  'React Native Firebase latest published at: 2026-08-10T13:49:48.317Z',
  'React Native Firebase npm repository: git+https://github.com/invertase/react-native-firebase.git#main',
  'React Native Firebase Messaging latest version: 26.2.0',
  'React Native Firebase Messaging peer app version: 26.2.0',
...
assertRejected('Missing latest Firebase fixture', validSummary.replace('React Native Firebase latest version: 26.2.0', 'React Native Firebase latest version: missing'), 'latest version');
assertRejected(
  'Missing latest publish timestamp fixture',
  validSummary.replace('React Native Firebase latest published at: 2026-08-10T13:49:48.317Z', 'React Native Firebase latest published at: missing'),
  'published timestamp',
);
assertRejected(
...
assertRejected(
  ...
  validSummary.replace('React Native Firebase Messaging latest version: 26.2.0', 'React Native Firebase Messaging latest version: 23.0.0'),
  'Messaging latest version',
);
assertRejected(
  'Messaging peer mismatch fixture',
  validSummary.replace('React Native Firebase Messaging peer app version: 26.2.0', 'React Native Firebase Messaging peer app version: 23.0.0'),
