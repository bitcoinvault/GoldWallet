...
assertRejected('Missing latest Firebase fixture', validSummary.replace('React Native Firebase latest version: 24.1.1', 'React Native Firebase latest version: missing'), 'latest version');
assertRejected(
  'Missing latest publish timestamp fixture',
  validSummary.replace('React Native Firebase latest published at: 2026-06-10T02:35:38.524Z', 'React Native Firebase latest published at: missing'),
  'published timestamp',
);
assertRejected(
...
assertRejected(
  ...
  validSummary.replace('React Native Firebase Messaging latest version: 24.1.1', 'React Native Firebase Messaging latest version: 23.0.0'),
  'Messaging latest version',
);
assertRejected(
  'Messaging peer mismatch fixture',
  validSummary.replace('React Native Firebase Messaging peer app version: 24.1.1', 'React Native Firebase Messaging peer app version: 23.0.0'),
