...
const validSummary = [
  ...
  '@sentry/react-native manifest version: 8.19.0',
  ...
  '- Sentry 8.19.0 routes Android Gradle integration through sentry.gradle.kts; release source-map and dSYM behavior still require credentialed validation.',
  '- Sentry 8.19.0 still performs release bundle task argument extraction; check Android release Gradle output for "Could not extract bundle task arguments" before claiming source-map upload.',
  '- Sentry is on 8.19.0; source-map and dSYM behavior still require release validation with local Sentry credentials.',
  'Readiness issues: 0',
  'Wiring errors: 0',
