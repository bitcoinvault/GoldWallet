...
const validSummary = [
  ...
  '@sentry/react-native manifest version: 8.17.1',
  ...
  '- Sentry 8.17.1 routes Android Gradle integration through sentry.gradle.kts; release source-map and dSYM behavior still require credentialed validation.',
  '- Sentry 8.17.1 still performs release bundle task argument extraction; check Android release Gradle output for "Could not extract bundle task arguments" before claiming source-map upload.',
  '- Sentry is on 8.17.1; source-map and dSYM behavior still require release validation with local Sentry credentials.',
  'Readiness issues: 0',
  'Wiring errors: 0',
