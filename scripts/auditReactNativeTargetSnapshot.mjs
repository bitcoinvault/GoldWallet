...
export const expectedReactNativeTargetSnapshot = {
  ...
  npmNextReactNative: '0.87.0-rc.3',
  npmNightlyReactNative: '0.88.0-nightly-20260730-8e7446412',
...
export const requiredReactNativeTargetSnapshotSnippets = [
  ['docs/react-native-target-snapshot.md', 'NPM snapshot date: `2026-07-30`'],
  ...
  ['docs/react-native-target-snapshot.md', 'npm `next`: `0.87.0-rc.3`'],
  ['docs/react-native-target-snapshot.md', 'npm `nightly` last observed: `0.88.0-nightly-20260730-8e7446412`'],
