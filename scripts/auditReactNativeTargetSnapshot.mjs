...
export const expectedReactNativeTargetSnapshot = {
  ...
  currentReactNative: '0.87.0',
  currentReact: '19.2.3',
  currentNode: '24.16.0',
  npmLatestReactNative: '0.87.0',
  ...
  targetNodeEngine: '^22.13.0 || ^24.3.0 || >= 26.0.0',
};

export const requiredReactNativeTargetSnapshotSnippets = [
  ['docs/react-native-target-snapshot.md', 'NPM snapshot date: `2026-08-11`'],
  ['docs/react-native-target-snapshot.md', 'Current repo React Native: `0.87.0`'],
  ...
  ['docs/react-native-target-snapshot.md', 'npm `latest`: `0.87.0`'],
  ...
  ['docs/react-native-target-snapshot.md', 'Latest live verification: `2026-08-11`'],
  ['docs/react-native-target-snapshot.md', 'React peer for `react-native@0.87.0`: `^19.2.3`'],
  ['docs/react-native-target-snapshot.md', 'Node engine for `react-native@0.87.0`: `^22.13.0 || ^24.3.0 || >= 26.0.0`'],
  ...
  ['docs/react-native-upgrade-path.md', 'As of the 2026-08-11 live probe'],
  ['docs/react-native-upgrade-path.md', 'npm `latest` is `0.87.0`; `0.87.0-rc.4` remains a historical prerelease tag'],
  ...
  ['docs/wallet-modernization-baseline.md', '`react-native@0.87.0` latest, `0.87.0-rc.4` next'],
  ['docs/wallet-modernization-baseline.md', 'Latest live RN target snapshot check on `2026-08-11` matched the recorded `2026-08-11` snapshot'],
  ...
  ['docs/react-native-foundation-target-matrix.md', 'Snapshot recorded: `2026-08-11`'],
  ['docs/react-native-foundation-target-matrix.md', 'Latest live verification: `2026-08-11`, outcome `matched`, mismatches `0`'],
...
const currentSnapshotFieldChecks = [
  ['docs/react-native-target-snapshot.md', 'NPM snapshot date', /^(?:- )?NPM snapshot date: `([^`]+)`$/m, '2026-08-11'],
  ['docs/react-native-target-snapshot.md', 'npm next', /^(?:- )?npm `next`: `([^`]+)`$/m, '0.87.0-rc.4'],
  ['docs/react-native-target-snapshot.md', 'latest live verification', /^(?:- )?Latest live verification: `([^`]+)`$/m, '2026-08-11'],
  ['docs/react-native-foundation-target-matrix.md', 'npm next', /^(?:- )?npm `react-native@next`: `([^`]+)`$/m, '0.87.0-rc.4'],
  ['docs/react-native-foundation-target-matrix.md', 'snapshot recorded', /^(?:- )?Snapshot recorded: `([^`]+)`$/m, '2026-08-11'],
  [
  ...
  ['docs/react-native-087-readiness.md', 'checked date', /^Checked: (\S+)$/m, '2026-08-11'],
  ['docs/react-native-087-readiness.md', 'current stable target', /^(?:- )?Current stable target: `react-native@([^`]+)`$/m, '0.87.0'],
  [
  ...
  [
    ...
    /Latest live RN target snapshot check on `(\d{4}-\d{2}-\d{2})` matched the recorded `2026-08-11` snapshot/,
    '2026-08-11',
  ],
];
