...
export const expectedReactNativeTargetSnapshot = {
  ...
  npmNightlyReactNative: '0.88.0-nightly-20260711-042833e69',
...
export const requiredReactNativeTargetSnapshotSnippets = [
  ['docs/react-native-target-snapshot.md', 'NPM snapshot date: `2026-07-11`'],
  ...
  ['docs/react-native-target-snapshot.md', 'npm `nightly`: `0.88.0-nightly-20260711-042833e69`'],
