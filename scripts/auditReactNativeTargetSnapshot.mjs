...
export const expectedReactNativeTargetSnapshot = {
  ...
  npmNightlyReactNative: '0.87.0-nightly-20260605-87184c8fb',
...
export const requiredReactNativeTargetSnapshotSnippets = [
  ['docs/react-native-target-snapshot.md', 'NPM snapshot date: `2026-06-05`'],
  ...
  ['docs/react-native-target-snapshot.md', 'npm `nightly`: `0.87.0-nightly-20260605-87184c8fb`'],
