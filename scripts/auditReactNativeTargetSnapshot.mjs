...
export const expectedReactNativeTargetSnapshot = {
  ...
  npmNightlyReactNative: '0.87.0-nightly-20260604-63683f091',
...
export const requiredReactNativeTargetSnapshotSnippets = [
  ['docs/react-native-target-snapshot.md', 'NPM snapshot date: `2026-06-04`'],
  ...
  ['docs/react-native-target-snapshot.md', 'npm `nightly`: `0.87.0-nightly-20260604-63683f091`'],
