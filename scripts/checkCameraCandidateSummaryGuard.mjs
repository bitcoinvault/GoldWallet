...
const validSummary = [
  ...
  'Metadata checked on: 2026-06-03',
...
assertRejected('Missing metadata date fixture', validSummary.replace('Metadata checked on: 2026-06-03', 'Metadata checked on: 2026-05-29'), 'Metadata checked on');
assertRejected(
